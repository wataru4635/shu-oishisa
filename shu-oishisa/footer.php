...
<footer class="footer">
<img src="<?php echo IMAGEPATH; ?>/common/footer-bg.svg" alt="" aria-hidden="true" width="1366" height="60" loading="lazy" class="footer__bg-img footer__bg-img--pc">
<img src="<?php echo IMAGEPATH; ?>/common/footer-bg-sp.svg" alt="" aria-hidden="true" width="390" height="50" loading="lazy" class="footer__bg-img footer__bg-img--sp">
  <div class="footer__inner">

    <a href="<?php echo HOME_URL; ?>" class="footer__logo">
        <img src="<?php echo IMAGEPATH; ?>/common/logo.webp" alt="餃子の秀のロゴマーク" width="156.944" height="51.828" loading="lazy" class="footer__img">
    </a>
      ...
      <nav class="footer-nav" aria-label="フッターナビゲーション">
        <ul class="footer-nav__list">
          ...
          <li class="footer-nav__item"><a href="<?php echo WHOLESALE_OEM_URL; ?>" class="footer-nav__link">卸販売 / OEM</a></li>
          <li class="footer-nav__item"><a href="#" class="footer-nav__link" target="_blank" rel="noopener noreferrer">ネットショップ</a></li>
